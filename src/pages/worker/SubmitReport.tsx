...
const assignedTasks = [
  { id: '1', title: 'Water Quality Testing', project: 'River Cleanup Initiative' },
  { id: '2', title: 'Sample Collection', project: 'River Cleanup Initiative' },
  { id: '3', title: 'Equipment Maintenance', project: 'River Cleanup Initiative' },
];
...
export default function SubmitReport() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (selectedTasks.length === 0) {
      toast({
        title: 'Task Required',
        description: 'Please select at least one related task.',
        variant: 'destructive',
      });
      return;
    }
