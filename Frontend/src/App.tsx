        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route element={<DashboardLayout allowedRoles={['manager']} />}>
              ...
              <Route path="/manager/projects" element={<ManagerProtectedWrapper><ManagerProjects /></ManagerProtectedWrapper>} />
              <Route path="/manager/tasks" element={<ManagerProtectedWrapper><ManagerTasks /></ManagerProtectedWrapper>} />
              <Route path="/manager/attendance" element={<ManagerProtectedWrapper><ManagerAttendance /></ManagerProtectedWrapper>} />
              <Route path="/manager/reports" element={<ManagerProtectedWrapper><ManagerReports /></ManagerProtectedWrapper>} />
              <Route path="/manager/leave" element={<ManagerProtectedWrapper><ManagerLeaves /></ManagerProtectedWrapper>} />
            </Route>
            ...
            <Route element={<DashboardLayout allowedRoles={['admin', 'manager', 'worker']} />}>
